...
const Produtos: React.FC = () => {
  ...
  const paginados = produtosFiltrados.slice(
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <thead className="bg-gray-50">
              <tr>
                ...
                >
                  <div className="flex items-center">
                    Conjunto
                    <SortIcon column="conjunto" />
                  </div>
                </th>
                <th
                  onClick={() => handleSort("subconjunto")}
                  className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
                >
                  <div className="flex items-center">
                    Subconjunto
                    <SortIcon column="subconjunto" />
                  </div>
                </th>
                <th
        ...
        <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
          <p className="text-sm text-gray-700">
            ...
            a{" "}
            <span className="font-medium">
              {Math.min(currentPage * itemsPerPage, produtosFiltrados.length)}
            </span>{" "}
            de <span className="font-medium">{produtosFiltrados.length}</span>{" "}
            resultados
          </p>
          <nav
