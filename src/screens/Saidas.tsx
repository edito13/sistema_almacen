  ...
  const data: SaidaItem[] = [
    {
      ...
      conceito: "Envio para filial",
      quantidade: 2,
      responsavelEntrega: "João Silva",
      responsavelRecebimento: "Ana Costa",
      destino: "Filial SP",
      dataSaida: "2025-05-10",
      dataEntrega: "2025-05-12",
    },
    {
      id: 2,
      produto: "Teclado Logitech",
      conceito: "Atendimento cliente",
      quantidade: 3,
      responsavelEntrega: "Maria Souza",
      responsavelRecebimento: "Pedro Ramos",
      destino: "Cliente XYZ",
      dataSaida: "2025-05-11",
      dataEntrega: "2025-05-13",
    },
    // ... mais itens
  ];
    ...
    (item) =>
      ...
      (responsavelEntrega === "" ||
        item.responsavelEntrega
          .toLowerCase()
          .includes(responsavelEntrega.toLowerCase())) &&
      (responsavelRecebimento === "" ||
        item.responsavelRecebimento
          .toLowerCase()
          .includes(responsavelRecebimento.toLowerCase())) &&
      (destino === "" ||
        item.destino.toLowerCase().includes(destino.toLowerCase()))
  );
