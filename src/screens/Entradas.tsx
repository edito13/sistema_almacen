...
const Entradas: React.FC = () => {
  ...
  const data: EntradaItem[] = [
    { id: 1, produto: "Monitor Dell 24\"", conceito: "Nova compra", quantidade: 10, fornecedor: "Dell Computadores", dataEntrada: "2025-05-01" },
    { id: 2, produto: "Teclado Logitech", conceito: "Reposição", quantidade: 5, fornecedor: "Logitech Brasil", dataEntrada: "2025-05-03" },
    { id: 3, produto: "Cabo HDMI", conceito: "Compra externa", quantidade: 20, fornecedor: "MultiCabos", dataEntrada: "2025-05-05" },
    // ... mais itens
  ];
      ...
      <div className="bg-gray-50 min-h-screen p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-orange-500 to-orange-400 rounded-lg p-6 shadow-md mb-6 flex justify-between items-center">
            <h1 className="text-2xl font-bold text-white">Entradas no Almoxarifado</h1>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              {paginados.map(item => (
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.fornecedor}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.dataEntrada}</td>
                  </tr>
              ))}
              </tbody>
            </table>
              ...
              <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Paginação">
                ...
                {Array.from({ length: totalPaginas }, (_, i) => (
                    <button
                        ...
                        className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium ${paginaAtual === i + 1 ? 'bg-orange-50 text-orange-500' : 'bg-white text-gray-500'} hover:bg-gray-50`}
                    >
                      {i + 1}
                    </button>
                ))}
